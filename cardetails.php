...
<?php 
  ...
  <div class="cd">
    <div class="main">
        <div class="navbar">
            <div class="icon">
            <img id="logo" src="images/ridex1.png" style=" width: 100px;
    height: 100px;
...
></a>
      ...
      <div><h1 class="overview">OUR CARS </h1>
    ...
    <div class="box">
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a href="booking.php?id=<?php echo $res;?>">Rent</a></button>
        </div>
    </div></form></li>
    <?php
        }
